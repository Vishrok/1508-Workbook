...
-- alternatively, I don't need to specify a column
...
FROM   PaymentType
-- TODO: Student Answer Here
SELECT COUNT(1) AS 'Types of Payments'
FROM PaymentType
...
SELECT COUNT(Activity.StudentID) AS 'Student Count'
FROM Activity
